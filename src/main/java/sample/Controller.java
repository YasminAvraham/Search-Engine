...
public class Controller implements Initializable{
    ...
    public void reset(ActionEvent event) throws IOException {
        if (!postingPath.equals("")) {
            FileUtils.deleteDirectory(new File(postingPath + File.separator + "Stem"));
            FileUtils.deleteDirectory(new File(postingPath + File.separator + "WithOutStem"));
            indexInstance.reset();
            newPostingPath = "";
    ...
    public void  runBrowseQuery(ActionEvent event) throws IOException {
        ...
        try {
            ...
            alert.setTitle("APP Dialog");
            alert.setHeaderText("System Message");
            alert.setContentText("Dictionary Is Not Loaded");
            alert.show();
        }
        catch (Exception e) {
            Alert alert = new Alert(Alert.AlertType.INFORMATION);
